...
import { Menu } from "@/components/PostsFilter"
    ...
    <div className="flex items-center space-x-4">
      ...
      <UserNav />
        ...
        <div className="pt-16 flex">
          <div className="bg-background fixed top-16 left-0 bottom-0 w-64">
          ...
          {/* <div className="sticky top-16 w-64">
             <RighSidebar playlists={playlists} className="hidden lg:block" />
          </div> */}
