...
const Voting: React.FC<VotingProps> = ({ className }) => {
  ...
  return (
    ...
    <div  className={cn("hidden items-center bg-background gap-1.5 p-[2px]  md:flex", className)}>
    <ToggleGroup type="single" defaultValue={null} aria-label="Vote" className="flex items-center">
      <ToggleGroupItem
        value="upvote"
