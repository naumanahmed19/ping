...
type Team = (typeof groups)[number]["teams"][number] & { id: string, image?: string }

type PopoverTriggerProps = React.ComponentPropsWithoutRef<typeof PopoverTrigger>

interface TeamSwitcherProps extends PopoverTriggerProps {}

export default function TeamSwitcher({ className, value, onSelect }: TeamSwitcherProps) {
