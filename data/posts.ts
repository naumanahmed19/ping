...
export const posts: Post[] = [
  {
    ...
    community: {
      ...
      description:
        "Nature is truly breathtaking! The colors were so vibrant and the sky looked like it was on fire. It was a perfect end to a great day. I felt so at peace watching the sun go down.",
      members: 1000,
      online: 50,
      rank: 1,
