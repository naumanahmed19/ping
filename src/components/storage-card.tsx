  ...
  return (
    <Card className="rounded-md text-xs shadow-sm">
      <CardContent className="flex items-start gap-2.5 p-2.5">
        <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-md bg-slate-100 text-slate-900 dark:bg-slate-800 dark:text-slate-50">
          <Database className="h-5 w-5 text-slate-500 dark:text-slate-400" />
        </div>
        <div className="grid flex-1 gap-1">
          <p className="font-medium">Running out of space?</p>
          <p className="text-slate-500 dark:text-slate-400">79.2 GB / 100 GB used</p>
          <Progress
            value={79.2}
            className="mt-1"
