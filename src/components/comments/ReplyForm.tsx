...
import { Card, CardContent, CardFooter } from "@/components/ui/card"; // Assuming these are imported from somewhere
...
const ReplyForm = ({ showReplyForm, onCancel }: ReplyFormProps) => {
  const handleSubmit = () => {
